...
export default function UuidCollecting() {
  ...
  return (
    <>
      <div className='fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 '>
        <div className='flex flex-col w-80 h-40 rounded-xl bg-white border-gray-200 border-2 justify-center items-center relative'>
          ...
          <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center'>
            ...
            <span className='ml-1 text-sm text-black'>UUID collecting...</span>
          </div>
